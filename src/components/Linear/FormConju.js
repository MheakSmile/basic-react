                            ...
                            block
                                ...
                                onClick={async () => {
                                    const res = await axios.post(
                                        'http://localhost:8080/api/v1/linear/conjugate',
                                        data
                                    )
                                    console.log(res)
                                    setResults(
                        ...
                        <Table  bordered hover >
                            ...
                            <tbody>
                                {results.map((g) => (
                                    <tr key={g.iteration}>
                                        <td>{g.iteration}</td>
                                        <td>{parseFloat(g.l.toFixed(5))}</td>
                                        <td>{parseFloat(g.x1.toFixed(5))}</td>
                                        <td>{parseFloat(g.x2.toFixed(5))}</td>
                                        <td>{parseFloat(g.x3.toFixed(5))}</td>
                                        <td>{parseFloat(g.r1.toFixed(5))}</td>
                                        <td>{parseFloat(g.r2.toFixed(5))}</td>
                                        <td>{parseFloat(g.r3.toFixed(5))}</td>
                                        <td>{g.err}</td>
                                        <td>{parseFloat(g.a1.toFixed(5))}</td>
                                        <td>{parseFloat(g.d1.toFixed(5))}</td>
                                        <td>{parseFloat(g.d2.toFixed(5))}</td>
                                        <td>{parseFloat(g.d3.toFixed(5))}</td>
                                    </tr>
                                ))}
                            </tbody>
                        </Table>
